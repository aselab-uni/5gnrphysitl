...
class TxFlowgraph:
    """GNU Radio TX visualization flowgraph fed by the Python PHY waveform."""
    ...
    def __init__(self, waveform: np.ndarray, sample_rate: float) -> None:
        ...
        self.tb = gr.top_block("nr_tx_flowgraph")
        ...
        self.time_sink = qtgui.time_sink_c(1024, sample_rate, "TX Waveform", 1)
        self.freq_sink = qtgui.freq_sink_c(2048, window.WIN_BLACKMAN_hARRIS, 0, sample_rate, "TX Spectrum", 1)
